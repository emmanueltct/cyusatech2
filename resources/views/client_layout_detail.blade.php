	...
	<body id="top">
        ...
        <section id="banner2" >
			<div class="container">
				<div class="row">
					<div class="col-md-12" >
						<div class="block" style="background: #ECE9E6;background: linear-gradient(to right, #FFFFFF, #ECE9E6);margin-top:55px;height:90px;">
							<div class="title" style="margin-top:1%;padding-top:2%">
