        ...
        <header id="navigation" class="navbar-fixed-top animated-header" style="padding:5px; border-bottom: 5px solid green;">
            <div class="container" style="">
				...
				<ul id="nav" class="nav navbar-nav menu">
                        <li><a href="{{route('admin_staff')}}">Stafff</a></li>
						<li><a href="{{route('admin_partners')}}">Partners</a></li>
                        <li><a href="{{route('admin_services')}}">Service</a></li>
                        <li><a href="{{route('admin_projects')}}">Project</a></li>
                        <li><a href="{{route('admin_shops')}}">Shop</a></li>
                        <li><a href="{{route('admin_testimonials')}}">Testimonial</a></li>
						<li>
							<li>
							@if(Session::has('user_in'))
